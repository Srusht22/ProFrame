...
const Map<T, String> kurdishStrings = {
  ...
  T.preview25d: 'پێشبینینی سێ ڕەهەندی',
  T.toolDraw: 'کێشان',
  ...
  T.sketchPanelTitle: 'وێنەکەت',
  T.sketchPanelHelp:
      'ئەوەی کێشاوتە، لەگەڵ ئەوەی لێی دروستکراوە لەسەری. هەردووکیان بە یەک '
          'قەبارەن، بۆیە دەکرێت هێڵ بە هێڵ بەراورد بکرێن.',
  T.showSketch: 'وێنەکەت پیشان بدە',
  T.showProduct: 'بەرهەمەکە پیشان بدە',
